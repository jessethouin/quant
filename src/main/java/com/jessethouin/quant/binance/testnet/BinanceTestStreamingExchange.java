...
import static com.jessethouin.quant.binance.BinanceExchangeServices.BINANCE_API_CONFIG;
...
public class BinanceTestStreamingExchange extends BinanceExchange implements StreamingExchange {

    private static final Logger LOG = LoggerFactory.getLogger(BinanceStreamingExchange.class);
    private static final String API_BASE_URI = BINANCE_API_CONFIG.getStreamApi();
    ...
    private BinanceTestStreamingAccountService streamingAccountService;
    private BinanceTestStreamingTradeService streamingTradeService;

    private BinanceTestUserDataChannel userDataChannel;
    ...
    public Completable connect(ProductSubscription... args) {
        ...
        if (subscriptions.hasAuthenticated()) {
            ...
            BinanceAuthenticated binance =
                    ExchangeRestProxyBuilder.forInterface(
                            ...
                            .build();
            userDataChannel =
                    new BinanceTestUserDataChannel(binance, exchangeSpecification.getApiKey(), onApiCall);
            try {
                completables.add(createAndConnectUserDataService(userDataChannel.getListenKey()));
            } catch (BinanceTestUserDataChannel.NoActiveChannelException e) {
        ...
        streamingAccountService = new BinanceTestStreamingAccountService(userDataStreamingService);
        streamingTradeService = new BinanceTestStreamingTradeService(userDataStreamingService);
    ...
    @Override
    public BinanceTestStreamingAccountService getStreamingAccountService() {
        return streamingAccountService;
    }

    @Override
    public BinanceTestStreamingTradeService getStreamingTradeService() {
